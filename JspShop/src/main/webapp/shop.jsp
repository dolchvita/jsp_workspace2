...
<%
	...
	if(request.getParameter("category_idx")==null){
		...
		productList=productDAO.selectByCategory(Integer.parseInt(category_idx));
	}
                                ...
                                <div class="accordion" id="accordionExample">
                                    ...
                                    <div class="card">
                                        <div class="card-heading">
                                            <a data-target="#collapse<%=i%>" onClick="getProductList(<%=category.getCategory_idx()%>)"><%=category.getCategory_name() %></a>
                                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6">
                            ...
                            <%
                            	...
                            	if(product.getPimgList()==null){
                            		filename="img/shop/shop-1.jpg";
                            	}else{
                            		filename="/data/"+product.getPimgList().get(0).getFilename();
                            	}
                            %>
                                <div class="product__item__pic set-bg" data-setbg=<%=filename %>>
